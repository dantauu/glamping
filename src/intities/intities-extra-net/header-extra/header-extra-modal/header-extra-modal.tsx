...
import style from './header-extra-modal.module.scss'

const HeaderExtraModal = ({ isActive }: any) => {
   return (
      <>
      {isActive && (
      <div className={style.mainWrapper}>         
         <div className={style.wrapper}>
            ...
            <Link href={'/extra-net-auth/register-mail-number'} 
             ...
             <Link href={'/add-card-object/object'} className={style.headerConnect}>
...
export default HeaderExtraModal