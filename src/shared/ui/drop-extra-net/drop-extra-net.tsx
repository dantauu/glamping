...
import { questTextExtraNet } from '../../../../public/data/data'
import style from './drop-extra-net.module.scss'

const DropExtraNet = ({ title }: { title: string }) => {
		...
		<div className={style.dropQurstionWrapper}>
			<div className={style.dropQuestion}>
				...
				<div
					...
					className={`${style.img} ${showQuestion && style.imgActive}`}
				>
					<svg
						width='14'
						height='9'
			...
			<div className={style.textWrapper}>
				{showQuestion && (
					<>
						{questTextExtraNet.map((item, inedx) => (
