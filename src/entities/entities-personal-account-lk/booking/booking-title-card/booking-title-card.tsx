...
import style from './booking-title-card.module.scss'
import { useMediaQuery } from '@/hooks/useMediaQuery'
import BookingTitleCardMobile from './booking-title-card-mobile/booking-title-card-mobile'

const BookingTitleCard = () => {
    const isMobile = useMediaQuery('(max-width: 1360px)')
    return (
        <>
        {isMobile ? <BookingTitleCardMobile /> : (
